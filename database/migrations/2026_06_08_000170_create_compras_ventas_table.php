...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('compras', function (Blueprint $table) {
            ...
            $table->enum('metodo_pago', ['EFECTIVO', 'TARJETA', 'TRANSFERENCIA', 'CREDITO', 'MIXTO'])->default('EFECTIVO');
            ...
            $table->enum('estado_documento', ['REGISTRADA', 'RECEPCIONADA', 'ANULADA', 'PENDIENTE'])->default('REGISTRADA')->index();
        ...
        Schema::create('ventas', function (Blueprint $table) {
            ...
            $table->enum('estado_documento', ['REGISTRADA', 'EMITIDA', 'ANULADA', 'PENDIENTE'])->default('REGISTRADA')->index();
            $table->text('observacion')->nullable();
            $table->text('motivo_anulacion')->nullable();
            $table->timestamp('anulado_at')->nullable();
        ...
        Schema::create('pagos_venta', function (Blueprint $table) {
            $table->id();
            $table->foreignId('venta_id')->constrained('ventas')->cascadeOnDelete();
            $table->enum('metodo_pago', ['EFECTIVO', 'TARJETA', 'TRANSFERENCIA', 'YAPE', 'PLIN', 'OTRO'])->index();
