    ...
    <table id="tabla_detalle" class="table table-hover mb-0 align-middle">
        <thead class="bg-light">
            <tr>
                ...
                <th class="border-bottom-0 text-end">Costo</th>
        ...
        <tfoot class="bg-light">
            <tr>
                <th colspan="7" class="text-end fw-semibold">Subtotal bruto:</th>
                <th class="text-end text-dark">S/ <span id="subtotal_bruto">0.00</span></th>
                <th></th>
            </tr>
            <tr>
                <th colspan="7" class="text-end fw-semibold">Descuento total:</th>
                <th class="text-end text-danger">S/ <span id="descuento_total">0.00</span></th>
                <th></th>
            </tr>
            <tr>
                <th colspan="7" class="text-end fw-semibold">IGV (18%):</th>
                <th class="text-end text-dark">S/ <span id="igv">0.00</span></th>
                <th></th>
            </tr>
            <tr>
                <th colspan="7" class="text-end fw-bold text-dark fs-6">TOTAL:</th>
