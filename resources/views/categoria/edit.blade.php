...
<div class="container-fluid px-3 px-md-4 py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h2 class="fw-bolder text-dark mb-0 fs-3">Editar Categoría</h2>
        ...
        <span class="badge bg-light text-secondary border px-3 py-2 shadow-sm">ID: {{ $categoria->id }}</span>
    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 mt-4 d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3 border-top pt-4">
                        ...
                        <div class="d-flex gap-2 w-100 w-sm-auto">
                            <a href="{{ route('categorias.index') }}" class="btn btn-light px-4 border shadow-sm fw-medium flex-grow-1 flex-sm-grow-0">Cancelar</a>
