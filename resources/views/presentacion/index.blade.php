                ...
                <table id="datatablesSimple" class="table table-hover table-custom">
                    <thead>
                        <tr>
                            ...
                            @canany(['editar-presentacion', 'eliminar-presentacion'])
                            ...
                            <tr>
                                ...
                                <td class="text-center align-content-center">
                                    <div class="btn-group shadow-sm" role="group">
                                        ...
                                        <a href="{{ route('presentaciones.edit', $item) }}" class="btn btn-sm btn-outline-secondary text-primary border-light" title="Editar">
                                    ...
                                    <div class="modal-content border-0 shadow">
                                        ...
                                        <div class="modal-body text-center pb-4">
                                            @if(!$item->trashed())
                                                ...
                                                <p class="text-muted">La presentación "{{ $item->nombre }}" ya no estará disponible para nuevas transacciones.</p>
                                            @else
                                                <div class="text-success mb-3"><i class="fas fa-check-circle fa-4x"></i></div>
                                                <h4 class="fw-bold text-dark">¿Restaurar presentación?</h4>
                                                <p class="text-muted">La presentación "{{ $item->nombre }}" volverá a estar activa en el sistema.</p>
                                            @endif
                                        </div>
                                        <div class="modal-footer border-0 pt-0 justify-content-center">
                                            <button type="button" class="btn btn-light px-4" data-bs-dismiss="modal">Cancelar</button>
                                            <form action="{{ route('presentaciones.destroy', $item) }}" method="post">
                                                @method('DELETE')
                                                @csrf
