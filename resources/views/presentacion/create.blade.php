...
<div class="container-fluid px-4 py-4">
    <div class="mb-4">
        <h2 class="fw-bold text-dark mb-0">Nueva Presentación</h2>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control border-start-0 @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" placeholder="Ej. Caja, Botella, Kilogramo...">
                        </div>
                        @error('nombre')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="sigla" id="sigla" class="form-control border-start-0 @error('sigla') is-invalid @enderror" value="{{ old('sigla') }}" placeholder="Ej. CAJ, KG, L" required>
                        </div>
                        @error('sigla')
                            <div class="text-danger mt-1 small"><i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}</div>
                        @enderror
