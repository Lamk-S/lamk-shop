...
<style>
    #box-razon-social, #label-natural, #label-juridica { 
        display: none; 
    }
</style>
@endpush
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 w-100 mx-auto" style="max-width: 800px;">
        <div class="card-header bg-white border-bottom border-light p-4">
            <h5 class="mb-0 fw-semibold text-dark"><i class="fa-solid fa-address-card text-primary me-2"></i>Datos del Cliente</h5>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="numero_documento" id="numero_documento" class="form-control border-start-0 @error('numero_documento') is-invalid @enderror" value="{{ old('numero_documento') }}" placeholder="Ej. 74839201">
                        </div>
                    ...
                    <!-- Razón Social / Nombres (Aparece mediante JS) -->
                    <div class="col-md-12" id="box-razon-social">
                        ...
                        <label id="label-juridica" for="razon_social" class="form-label fw-medium text-secondary">Razón Social o Nombre de la empresa <span class="text-danger">*</span></label>
                        
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0 text-muted"><i class="fas fa-user-tie"></i></span>
                            <input type="text" name="razon_social" id="razon_social" class="form-control border-start-0 @error('razon_social') is-invalid @enderror" value="{{ old('razon_social') }}" placeholder="Escriba el nombre completo...">
                        </div>
                        @error('razon_social')
                            <div class="text-danger mt-1 small"><i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="direccion" id="direccion" class="form-control border-start-0 @error('direccion') is-invalid @enderror" value="{{ old('direccion') }}" placeholder="Ej. Av. Principal 123, Ciudad">
                        </div>
                        @error('direccion')
                            <div class="text-danger mt-1 small"><i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}</div>
                        @enderror
...
<script>
    $(document).ready(function() {
        ...
        function toggleLabels() {
            ...
            if (selectValue) {
                if (selectValue.toLowerCase() === 'natural') {
                    $('#label-juridica').hide();
                    $('#label-natural').show();
                } else {
                    $('#label-natural').hide();
