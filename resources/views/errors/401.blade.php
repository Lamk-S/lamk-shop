        ...
        <div class="error-card">
            ...
            <div class="error-body">
                ...
                <p class="error-description">
                    No dispone de los permisos necesarios para acceder a este recurso. Si considera que se trata de un error, póngase en contacto con el administrador del sistema.
                </p>
                <a href="{{ auth()->check() ? route('panel') : route('login') }}" class="btn btn-dark btn-return">
