...
<div class="container-fluid px-4 py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h2 class="page-title text-dark mb-0">Editar Marca</h2>
            <ol class="breadcrumb mb-0 mt-1 fs-7">
                <li class="breadcrumb-item"><a href="{{ route('panel') }}" class="text-decoration-none">Inicio</a></li>
                <li class="breadcrumb-item"><a href="{{ route('marcas.index') }}" class="text-decoration-none">Marcas</a></li>
                <li class="breadcrumb-item active">Registro #{{ $marca->id }}</li>
            </ol>
        </div>
        <span class="badge bg-light text-secondary border px-3 py-2">ID: {{ $marca->id }}</span>
    </div>

    <div class="card soft-card mx-auto" style="max-width: 760px;">
                    ...
                    <div class="col-12 mt-4 d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3 border-top pt-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="submit" class="btn btn-primary px-5 shadow-sm fw-bold">
                                <i class="fas fa-sync-alt me-2"></i>Actualizar marca
                            </button>
                        </div>
                    </div>
                </div>
