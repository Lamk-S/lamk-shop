...
<div class="container-fluid px-4 py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h2 class="page-title text-dark mb-0">Nueva Talla</h2>
        ...
        <div class="card-header soft-header p-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-muted small">Registra una referencia clara y reutilizable para el inventario.</div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="tipo_talla" id="tipo_talla" class="form-select @error('tipo_talla') is-invalid @enderror">
                            ...
                            <option value="CALZADO" @selected(old('tipo_talla') === 'CALZADO')>Calzado</option>
                            <option value="ROPA" @selected(old('tipo_talla') === 'ROPA')>Ropa</option>
                            <option value="UNICA" @selected(old('tipo_talla') === 'UNICA')>Única</option>
                        </select>
                        @error('tipo_talla')
                            <div class="text-danger mt-1 small">
                                <i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nombre') }}"
                               placeholder="Ej. Talla 40, M, Única"
                               maxlength="100">
                        @error('nombre')
                            <div class="text-danger mt-1 small">
                                <i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}
                    ...
                    <div class="col-12 mt-4 d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3 border-top pt-4">
                        <span class="text-muted small">
                            <i class="fas fa-shield-alt me-2"></i>Usa códigos cortos y consistentes para facilitar filtros y variantes.
                        </span>
                        <div class="d-flex gap-2">
                            ...
                            <button type="submit" class="btn btn-primary px-5 shadow-sm fw-bold">
                                <i class="fas fa-save me-2"></i>Guardar talla
                            </button>
                        </div>
                    </div>
                </div>
