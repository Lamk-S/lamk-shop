                ...
                <div class="card-body p-4 p-sm-5">
                    ...
                    <form action="/login" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control bg-dark border-secondary text-white rounded-3" name="email" id="inputEmail" type="email" placeholder="name@example.com" value="{{ old('email') }}" required autofocus />
                            <label for="inputEmail" class="text-muted"><i class="bi bi-envelope me-2"></i>Correo electrónico</label>
                        </div>
                        
                        <div class="form-floating mb-4">
                            <input class="form-control bg-dark border-secondary text-white rounded-3" name="password" id="inputPassword" type="password" placeholder="Password" required />
                            <label for="inputPassword" class="text-muted"><i class="bi bi-shield-lock me-2"></i>Contraseña</label>
                        </div>
