                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-muted small text-truncate" style="max-width: 200px;" title="{{ $item->persona->direccion }}">
                                        <i class="fas fa-map-marker-alt me-1"></i>{{ $item->persona->direccion }}
                                    </div>
                                </td>
                                <td>
                                    <div class="small mb-1 text-muted">{{ $item->persona->documento->tipo_documento }}</div>
                                    <div class="fw-medium text-dark"><i class="fas fa-id-card text-secondary me-1"></i>{{ $item->persona->numero_documento }}</div>
                                </td>
                                ...
                                <td class="text-center align-content-center">
                                    <div class="btn-group shadow-sm" role="group">
                                        ...
                                        <a href="{{ route('proveedores.edit', ['proveedore' => $item]) }}" class="btn btn-sm btn-outline-secondary text-primary border-light" title="Editar">
